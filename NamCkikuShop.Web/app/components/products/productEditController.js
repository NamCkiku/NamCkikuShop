    ...
    function productEditController(apiService, $scope, notificationService, $state, commonService, $stateParams) {
        ...
        function UpdateProduct() {
            ...
            apiService.put('/api/product/update', $scope.product,
                function (result) {
                    notificationService.displaySuccess(result.data.Name + ' đã được cap nhap thanh cong .');
                    $state.go('product');
                }, function (error) {
                    notificationService.displayError('Cap Nhap không thành công.');
                });
        }
...
})(angular.module('namckikuShop.product'));